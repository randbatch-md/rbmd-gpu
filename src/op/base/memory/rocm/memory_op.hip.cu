...
namespace op {
	...
	template struct delete_memory_op <rbmd::Id3, device::DEVICE_GPU>;
	...
	template struct resize_memory_op <rbmd::Id3, device::DEVICE_GPU>;
	...
	template struct sync_memory_h2d_op <rbmd::Id3, device::DEVICE_GPU>;
	...
	template struct sync_memory_d2h_op <rbmd::Id3, device::DEVICE_GPU>;
