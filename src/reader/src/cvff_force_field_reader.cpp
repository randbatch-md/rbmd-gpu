...
//    } \
//}
// CVFFForceFieldReader::CVFFForceFieldReader(const std::string& filePath,
// MDData& data) : 	StructureReder(filePath, data)
//{
//
// }
//
...
// }
//
// int CVFFForceFieldReader::ReadAtoms(const rbmd::Id& atoms_num)
//{
//	try
//	{
...
// }
//
// int CVFFForceFieldReader::ReadVelocity(const rbmd::Id& atoms_num)
//{
//	try
//	{
//		rbmd::Id atom_id;
