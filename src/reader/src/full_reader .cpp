...
//    } \
//}
// FullReader::FullReader(const std::string& filePath, MDData& data) :
//	StructureReder(filePath, data)
//{
//
// }
//
// int FullReader::ReadData()
//{
//	try
//	{
...
// }
//
// void FullReader::AllocateDataSpace()
//{
...
// }
//
// int FullReader::ReadAtoms(const rbmd::Id& atoms_num)
//{
//	try
//	{
...
//		for (auto num = 0; _locate < _file_size && num < atoms_num;
//++_locate)
//		{
//			if (_mapped_memory[_locate] == '\n')
//			{
...
// }
//
// int FullReader::ReadVelocity(const rbmd::Id& atoms_num)
//{
//	try
//	{
//		rbmd::Id atom_id;
