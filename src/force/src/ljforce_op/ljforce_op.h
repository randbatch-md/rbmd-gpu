...
struct LJForceOp {
  void operator()(Box* box, const rbmd::Real cut_off, const rbmd::Id num_atoms,
                  ...
                  const rbmd::Id* id_verletlist, const rbmd::Real* px,
...
struct LJForceVirialOp {
  void operator()(Box* box, const rbmd::Real cut_off, const rbmd::Id num_atoms,
                  ...
                  const rbmd::Real* py, const rbmd::Real* pz,
                  rbmd::Real* force_x, rbmd::Real* force_y, rbmd::Real* force_z,
                  rbmd::Real* virial_xx, rbmd::Real* virial_yy,
                  rbmd::Real* virial_zz, rbmd::Real* virial_xy,
                  rbmd::Real* virial_xz, rbmd::Real* virial_yz,
                  rbmd::Real* total_evdwl);
};

template <typename DEVICE>
struct LJRBLForceOp {
  void operator()(Box* box, const rbmd::Real rs, const rbmd::Real rc,
                  ...
                  const rbmd::Real* eps, const rbmd::Id* start_id,
...
struct FixLJRBLForceOp {
  void operator()(const rbmd::Id num_atoms, const rbmd::Real corr_value_x,
...
struct ComputeChargeStructureFactorComponentOp {
  void operator()(const rbmd::Id num_atoms, const Real3 K,
                  const rbmd::Real* charge, const rbmd::Real* px,
                  const rbmd::Real* py, const rbmd::Real* pz,
...
struct ComputeEwaldForceOp {
  void operator()(Box* box, const rbmd::Id num_atoms, const rbmd::Id Kmax,
                  ...
                  const rbmd::Real* pz, rbmd::Real* ewald_force_x,
                  rbmd::Real* ewald_force_y, rbmd::Real* ewald_force_z);
};
