...
void LJForce::Execute()
{
    ...
    LJforceOp(box, _num_atoms,
        ...
        thrust::raw_pointer_cast(_device_data->_d_start_id.data()),
        thrust::raw_pointer_cast(_device_data->_d_end_id.data()),
        thrust::raw_pointer_cast(_device_data->_d_id_verletlist.data()),
