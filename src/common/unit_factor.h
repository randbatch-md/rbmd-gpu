...
// };
//
// extern std::map<std::string, UNIT> unit_factor_map = {{"LJ", UNIT::LJ},
// {"REAL", UNIT::REAL}, {"METAL", UNIT::METAL}};
//
// template <UNIT>
// struct UnitFactor;
//
...
// };
//
// const rbmd::Real UnitFactor<UNIT::REAL>::_kb = 1.9872067 * std::pow(10.0,
// -3); const rbmd::Real UnitFactor<UNIT::REAL>::_fmt2v = 4.186 * std::pow(10.0,
// -4); const rbmd::Real UnitFactor<UNIT::REAL>::_mvv2e = 1.0 / (4.186 *
// std::pow(10.0, -4)); const rbmd::Real UnitFactor<UNIT::REAL>::_qqr2e =
// 332.06371;
//
///// METAL
// template <>
...
enum class UNIT { LJ = 0, REAL, METAL, UNKNOWN = -1 };
