...
void ShakeController::ShakeA() {
  ...
  shakeA_op(*(_structure_info_data->_num_angles), _dt, _fmt2v, *_box,
            ...
            thrust::raw_pointer_cast(
                _device_data->_d_angle_id_vec.data()),  // TODO: qw:Real3 is ok?
            ...
            thrust::raw_pointer_cast(
                _device_data->_d_flagZ.data()));  // TODO:FLAG & locator

  thrust::copy(_device_data->_d_shake_vx.begin(),
               _device_data->_d_shake_vx.end(), _device_data->_d_vx.begin());
  thrust::copy(_device_data->_d_shake_vy.begin(),
               _device_data->_d_shake_vy.end(), _device_data->_d_vy.begin());
  thrust::copy(_device_data->_d_shake_vz.begin(),
               _device_data->_d_shake_vz.end(), _device_data->_d_vz.begin());

  thrust::copy(_device_data->_d_shake_px.begin(),
               _device_data->_d_shake_px.end(), _device_data->_d_px.begin());
  thrust::copy(_device_data->_d_shake_py.begin(),
               _device_data->_d_shake_py.end(), _device_data->_d_py.begin());
  thrust::copy(_device_data->_d_shake_pz.begin(),
               _device_data->_d_shake_pz.end(), _device_data->_d_pz.begin());
}
...
void ShakeController::ShakeB() {
  ...
  shakeB_op(*(_structure_info_data->_num_angles), _dt, _fmt2v, *_box,
            ...
            thrust::raw_pointer_cast(_device_data->_d_fy.data()),
            thrust::raw_pointer_cast(
                _device_data->_d_fz.data()));  // TODO:FLAG & locator
