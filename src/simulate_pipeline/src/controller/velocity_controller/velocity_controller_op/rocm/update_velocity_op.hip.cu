...
//
//     // 欧拉法速度更新: v(t+Δt) = v(t) + a(t)*Δt
//     // 其中 a = F/m，fmt2v是单位转换因子
//     rbmd::Real ax = fx[tid] / mass[typei] * fmt2v;
//     rbmd::Real ay = fy[tid] / mass[typei] * fmt2v;
//     rbmd::Real az = fz[tid] / mass[typei] * fmt2v;
//
//     // 更新速度
//     sum_vx += ax * dt;
//     sum_vy += ay * dt;
