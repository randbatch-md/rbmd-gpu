...
int MDSystem::Evolve()
{
	...
	op::resize_memory_op<rbmd::Real>(d_dt, 1);
	op::resize_memory_op<rbmd::Real>(d_fmt2v, 1);
	op::resize_memory_op<rbmd::Real>(d_mass, potential_data._mass.size());
	op::resize_memory_op<rbmd::Real3>(d_v, nAtoms);
	op::resize_memory_op<rbmd::Real3>(d_force, nAtoms);
